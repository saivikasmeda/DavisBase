...
public class Page {
    ...
    public static int interiorpage(RandomAccessFile file) throws Exception
    {
        int count = 0;
        try{
    ...
    public static int leafpage(RandomAccessFile file) throws Exception
    {
        int count = 0;
        try{
            count = (int)(file.length()/(new Long(pageSize)));
    ...
    public static int findmiddlekey(RandomAccessFile file, int page) throws Exception
    {
        int val = 0;
        try{
    ...
    public static void splitLpage(RandomAccessFile file, int curPage, int newPage) throws Exception{
        try{
    ...
    public static void splitIpage(RandomAccessFile file, int curPage, int newPage) throws Exception
    {
        try{
    ...
    public static void splitlf(RandomAccessFile file, int page) throws Exception{
    ...
    public static int splitint(RandomAccessFile file, int page) throws Exception {
    ...
    public static void sortCell(RandomAccessFile file, int page) throws Exception
    {
    ...
    public static int[] getKey(RandomAccessFile file, int page) throws Exception{
    ...
    public static short[] getCellArr(RandomAccessFile file, int page) throws  Exception{
        int num = new Integer(getCellNum(file, page));
    ...
    public static int getPar(RandomAccessFile file, int page) throws  Exception{
        int val = 0;
    ...
    public static void setPar(RandomAccessFile file, int page, int parent) throws Exception
    {
        try{
            file.seek((page-1)*pageSize+8);
    ...
    public static long getPtrLoc(RandomAccessFile file, int page, int parent) throws Exception{
        long val = 0;
        try{
    ...
    public static void setPtrLoc(RandomAccessFile file, long loc, int parent, int page) throws  Exception{
        try{
            if(loc == 0){
    ...
    public static void insertIntCell(RandomAccessFile file, int page, int child, int key) throws Exception
    {
        try{
    ...
    public static boolean insertLfCell(RandomAccessFile file, int page, int offset, short plsize, int key, byte[] stc, String[] vals, String table) throws Exception{
        try{
            String s;
            file.seek((page-1)*pageSize+offset);
            String[] colName = DataReader.getColName(table);
...
//                        System.out.println("INT "+ vals[i]);
                    ...
                    case 0x0B:
                        ...
                        break;
                    default:
//                        System.out.println("string "+ vals[i]);
...
//            e.printStackTrace();
    ...
    public static void upLfCell(RandomAccessFile file, int page, int offset, int plsize, int key, byte[] stc, String[] vals, String table) throws Exception{
        try{
            String s;
            file.seek((page-1)*pageSize+offset);
            file.writeShort(plsize);
    ...
    public static int getRt(RandomAccessFile file, int page) throws Exception
    {
        int val = 0;
    ...
    public static void setRt(RandomAccessFile file, int page, int rightMost) throws Exception
    {
        try
        {
            file.seek((page-1)*pageSize+4);
    ...
    public static byte getCellNum(RandomAccessFile file, int page) throws Exception
    {
        byte val = 0;
        try
        {
    ...
    public static void setCellNum(RandomAccessFile file, int page, byte num) throws Exception
    {
        try{
            file.seek((page-1)*pageSize+1);
            file.writeByte(num);
    ...
    public static boolean checkInteriorSpace(RandomAccessFile file, int page) throws Exception
    {
    ...
    public static int checkLeafSpace(RandomAccessFile file, int page, int size) throws Exception
    {
        int val = -1;
    ...
    public static boolean hasKey(RandomAccessFile file, int page, int key) throws Exception
    {
    ...
    public static long getCellLoc(RandomAccessFile file, int page, int id) throws Exception
    {
        long loc = 0;
        try{
    ...
    public static short getCellOffset(RandomAccessFile file, int page, int id) throws Exception
    {
        short offset = 0;
        try{
            file.seek((page-1)*pageSize+12+id*2);
    ...
    public static void setCellOffset(RandomAccessFile file, int page, int id, int offset) throws Exception{
        try{
            file.seek((page-1)*pageSize+12+id*2);
            file.writeShort(offset);
        }
