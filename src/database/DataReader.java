...
public class DataReader {
    ...
    public static String[] retrievePayload(RandomAccessFile file, long location) throws  Exception{
    ...
    public static int calPayloadSize(String tableName, String[] values, byte[] bt) throws Exception{
        String[] dt = getDataType(tableName);
        int size = 1;
        size = size + dt.length -1;
        for(int i = 1 ;i< dt.length; i++){
//            System.out.println("dt " + dt[i]);
            byte temp = stcCode(values[i],dt[i]);
            bt[i-1] = temp;
//            System.out.println("bt" +bt[i-1]);
//            System.out.println("value" +values[i-1]);
            size = size+fieldLength(temp);
        }
        return size;
    }

    public static short fieldLength(byte bt) throws Exception{
        switch (bt){
            case 0x00: return 1;
            case 0x01: return 2;
            case 0x02: return 4;
    ...
    public static byte stcCode(String value, String dataType) throws Exception{
...
//            System.out.println("null");
            ...
            switch (dataType){
                ...
                case "STRING":        return (byte)(value.length()+0x0C);
                default:			return 0x00;
            }
        }
    }
    ...
    public static int searchKey(RandomAccessFile file, int key) throws Exception{
        int val = 1;
        try{
    ...
    public static String[] getDataType(String table) throws Exception
    {
        String[] dt = new String[0];
        try{
            RandomAccessFile dtfile = new RandomAccessFile("data//davisbase_columns.tbl", "rw");
...
//                table = DavisBase.currentDB+"."+table;
            ...
            for(String[] i : content.values()){
                array.add(i[3]);
//                System.out.println("datatypes " + i[3]);
            }
    ...
    public static String[] getColName(String table) throws Exception
    {
        String[] c = new String[0];
        try{
            RandomAccessFile cnfile = new RandomAccessFile("data//davisbase_columns.tbl", "rw");
            Buffer buffer = new Buffer();
...
//                table = DavisBase.currentDB+"."+table;
    ...
    public static String[] getNullable(String table) throws Exception
    {
...
//                table = DavisBase.currentDB+"."+table;
    ...
    public static void filter(RandomAccessFile file, String[] cmp, String[] columnName, String[] type, Buffer buffer) throws Exception{
        try{
            int num = pages(file);
    ...
    public static void filter(RandomAccessFile file, String[] cmp, String[] columnName, Buffer buffer) throws Exception{
        try{
            int numPages = pages(file);
    ...
    public static int pages(RandomAccessFile file) throws Exception
    {
        int num_pages = 0;
        try
        {
    ...
    public static boolean cmpCheck(String[] pl, int rowid, String[] cmp, String[] columnName) throws Exception
    {
